...
<html lang="it">
    <head>
        ...
        <title>Crea Tipologia Attrezzatura</title>
    ...
    <body class="text-center">
        <main class="form-signin">
            <h1 class="w-100 ">Crea Tipologia Attrezzatura</h1>
            <form action='' id='form' method='POST'>
                <div class="form-floating">
                    <input type="text" class="form-control" name="nome" placeholder="id" maxlength="50">
                    <label for="floatingInput">Nome</label>
                </div>
                <button class="w-100 btn btn-lg btn-success" type="submit" name="submit">Aggiungi</button>
                <a href="visualizzatipologiaattrezzatura.php" class="w-100 btn btn-lg btn-light">Indietro</a>
            </form>
        </main>
    </body>
</html>