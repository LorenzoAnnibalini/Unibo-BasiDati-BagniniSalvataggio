<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO `MAGAZZINO`(`Id`, `Descrizione`) VALUES ('".$id."', '".$descrizione."')";
        $result = $db->query($sql);
...
<html lang="it">
    ...
    <body class="text-center">
        <main class="form-signin">
            <h1 class="w-100 ">Crea Magazzino</h1>
            <form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='POST'>
                ...
                <a href="magazzini.php" class="w-100 btn btn-lg btn-light">Indietro</a>
            </form>
        </main>
    </body>
</html>