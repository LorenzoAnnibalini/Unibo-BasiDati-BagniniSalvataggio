<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO `TORRETTA`(`Id`, `Descrizione`) VALUES ('".$id."', '".$descrizione."')";
        $result = $db->query($sql);
...
<html lang="it">
    ...
    <body class="text-center">
        <main class="form-signin">
            <h1 class="w-100 ">Crea Torretta</h1>
            <form action='<?php echo $_SERVER['PHP_SELF']; ?>' method='POST'>
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" name="descrizione" placeholder="descrizione" maxlength="50">
                ...
                <a href="torrette.php" class="w-100 btn btn-lg btn-light">Indietro</a>
            </form>
        </main>
    </body>
</html>